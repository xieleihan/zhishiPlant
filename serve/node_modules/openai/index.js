...
class OpenAI extends Core.APIClient {
     ...
     */
    constructor({ baseURL = Core.readEnv('OPENAI_BASE_URL'), apiKey = Core.readEnv('OPENAI_API_KEY'), organization = Core.readEnv('OPENAI_ORG_ID') !== undefined && Core.readEnv('OPENAI_ORG_ID') !== null ? Core.readEnv('OPENAI_ORG_ID') : null, project = Core.readEnv('OPENAI_PROJECT_ID') !== undefined && Core.readEnv('OPENAI_PROJECT_ID') !== null ? Core.readEnv('OPENAI_PROJECT_ID') : null, ...opts } = {}) {
        if (apiKey === undefined) {
        ...
        super({
            ...
            timeout: options.timeout !== undefined && options.timeout !== null ? options.timeout : 600000 /* 10 minutes */,
...
class AzureOpenAI extends OpenAI {
    ...
    constructor({ baseURL = Core.readEnv('OPENAI_BASE_URL'), apiKey = Core.readEnv('AZURE_OPENAI_API_KEY'), apiVersion = Core.readEnv('OPENAI_API_VERSION'), endpoint, deployment, azureADTokenProvider, dangerouslyAllowBrowser, ...opts } = {}) {
        ...
        apiKey = apiKey !== undefined && apiKey !== null ? apiKey : API_KEY_SENTINEL;
    ...
    async prepareOptions(opts) {
         ...
         */
        if (opts.headers && opts.headers['api-key']) {
